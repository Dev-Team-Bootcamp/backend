...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240514205157_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Model.Survey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Model.Vote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Model.Option", b =>
                {
                    b.HasOne("Domain.Model.Survey", "Survey")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("OptionVote", b =>
                {
                    b.HasOne("Domain.Model.Option", null)
                        .WithMany()
                        .HasForeignKey("OptionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Model.Vote", null)
                        .WithMany()
